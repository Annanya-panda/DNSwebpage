...
import Route53DataTableComponent from './components/Route53DataTableComponent';
            ...
            <div className="App">
                <nav className="navbar navbar-expand-lg navbar-dark bg-dark">
                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul className="navbar-nav mr-auto">
                            <li className="nav-item">
                                <Link className="nav-link" to="/route53">Route53</Link>
                            </li>
                        </ul>
                    </div>
                </nav>
                ...
                <Routes>
                    ...
                    <Route path="/route53" element={<Route53DataTableComponent/>} />
